...
<div class="footerBottomSection">
    ...
    &copy; 2014, Allright reserved. <a href="#">Terms and Condition</a> | <a href="#">Privacy Policy</a>
        ...
        <div class="pull-right"><a href="index.html"><img src="${resource(dir: 'images/custom', file: 'logo1.png')}"
                                                          alt="My web solution"/></a></div>
    </div>
</div>
...
<script type="text/javascript"
        src="${resource(dir: 'js/datatable', file: 'jquery.dataTables.FixedColumns.min.js')}"></script>
